{ inputs }: let
  ...
  set-and-setting = inputs.set-and-setting;
  cavekit-src = inputs.cavekit-src;
in
{
      ...
      devShells = nixpkgs.lib.genAttrs [
        ...
        (set-and-setting.lib.mkDevShells {
          inherit pkgs;
          basePackages = (set-and-setting.lib.materializationFor { inherit pkgs; fragments = [ "base" "nix" "shell" "ascii" "markdown" "yaml" ]; }).packages;
          settingHook = ''
